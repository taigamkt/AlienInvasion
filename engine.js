...
var Game = new function() {
  ...
  // Game Initialization
  this.initialize = function(canvasElementId,sprite_data,callback, spritesimage) {
    ...
    SpriteSheet.load(sprite_data,callback, spritesimage);
  };
...
var SpriteSheet = new function() {
  ...
  this.load = function(spriteData,callback, spritesimage) {
    this.map = spriteData;
    this.image = new Image();
    this.image.onload = callback;
    this.image.src = spritesimage;
  };
